...
if "nilai_rapot" not in st.session_state:
    st.session_state["nilai_rapot"] = None

if "nilai_tka" not in st.session_state:
    st.session_state["nilai_tka"] = None

if "nilai_prestasi" not in st.session_state:
    st.session_state["nilai_prestasi"] = None
    ...
    with st.expander("Nilai Raport"):
        ...
        with st.form("form_login"):
            ...
            if submit:
                ...
                st.session_state["nilai_rapot"] = total / len(nilai_rapor_mapel)
    ...
    with st.expander("Nilai TKA"):
        ...
        with st.form("form_login_2"):
            ...
            if submit:
                ...
                st.session_state["nilai_tka"] = total / len(nilai_tka_mapel)

                st.metric(
                    label="Rata-rata Nilai",
                    value=f"{st.session_state["nilai_tka"]:.2f}"
                )
...
with col_center:
    with st.expander("🏆 Prestasi"):
        ...
        if submit_prestasi:
            ...
            st.divider()
            st.session_state["nilai_prestasi"] = skor
...
nr = st.session_state.get("nilai_rapot")
tka = st.session_state.get("nilai_tka")
sp = st.session_state.get("nilai_prestasi")
print(nr,tka,sp)
